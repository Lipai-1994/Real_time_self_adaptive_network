...
#########################################################################
@register_camera_to_factory()
class Fake_Camera(ImageGrabber):
    _name = 'Fake_Camera'

    def _read_frame(self):
    	_, left_frame = self._cam.read()
    	_, right_frame = self._cam1.read()
    	# import pdb; pdb.set_trace()
    	return left_frame, right_frame
    
    def _connect_to_camera(self):
    	self._cam = cv.VideoCapture("/home/lipai/self_adapt/Real-time-self-adaptive-deep-stereo/left.avi")
    	self._cam1 = cv.VideoCapture("/home/lipai/self_adapt/Real-time-self-adaptive-deep-stereo/right.avi")
